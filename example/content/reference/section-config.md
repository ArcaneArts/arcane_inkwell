...
JSON5 supports comments and trailing commas in configuration files:
...
| `icon` | `String?` | `null` | Single built-in Lucide icon name (see [Icons Reference](/reference/icons)) |
